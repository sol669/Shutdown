...
- `Shutdown-Trey-Setup-v1.0.0.exe` — компактный онлайн-установщик. Проверяет наличие .NET 8 и Windows App Runtime и загружает с серверов Microsoft только недостающие компоненты.
- `Shutdown-Trey-Portable-win-x64.zip` — компактная portable-версия. Требует, чтобы необходимые компоненты уже были установлены.

### Автономные версии

- `Shutdown-Trey-Setup-Offline-v1.0.0.exe` — автономный установщик со всеми компонентами внутри.
